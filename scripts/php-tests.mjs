...
const suites = ["backend/tests/recaptcha-decision.php", "backend/tests/config-isolation.php", "backend/tests/github-health.php", "backend/tests/api-error-shape.php", "backend/tests/health-vocabulary.php"];
