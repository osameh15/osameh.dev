...
export const caseStudies: ClientCaseStudy[] = [
  ...
  },
  {
    ...
    privacy: "public",
    summary: "A trust-driven recruitment marketplace connecting companies with professional recruiters. The frontend is implemented in Nuxt 3.17.6 with Nuxt 4 compatibility mode and runs as a development preview; the Go backend is planned and not built yet.",
    ...
    solution: [
      ...
      "Modelled the product invariants in the frontend, including the five-candidates-per-job submission cap, as named client-side constants - the planned backend must re-validate each rule server-side once it exists",
    ...
    stack: ["Nuxt 3.17.6 (Nuxt 4 compatibility mode)", "Vue 3.5", "TypeScript", "Tailwind CSS", "Pinia", "TanStack Query", "Nuxt i18n (fa/en, RTL)"],
    ...
    decisions: [
      ...
      "Planned, not implemented: a REST boundary to a Go 1.22+ service on Fiber, with PostgreSQL 16, Redis and MinIO behind it - documented as planned, never presented as deployed",
    ],
    outcomes: [
      "The current milestone delivers the frontend product architecture and interaction model, not a running platform",
      "Company, recruiter and admin flows are modelled end to end across the implemented frontend, built on Nuxt 3.17.6 in Nuxt 4 compatibility mode",
